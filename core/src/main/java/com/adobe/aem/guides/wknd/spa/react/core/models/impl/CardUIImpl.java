...
@Model(adaptables = SlingHttpServletRequest.class, adapters = { CardUI.class,
        ComponentExporter.class }, resourceType = CardUIImpl.RESOURCE_TYPE_CARDUI, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
